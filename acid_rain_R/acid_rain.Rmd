...
There should be a small blue box with an 'R' in it and the name of a project (this
will not be there on Rstudio cloud). We can check that R knows where we are with
the 'here()' function.
