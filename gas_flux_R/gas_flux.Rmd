...
a 'sink' of what we are interested in. Putting aside some weird solubility edge 
cases, sources will have a positive gradient and sinks will have a negative gradient. 
We only need *k* to tell us the magnitude of the effect!
...
Find the slope of each segment using a Sen's slope test. Show your slopes as an
output. 
(Hint: look at the Acid Rain homework for an example of this.)
