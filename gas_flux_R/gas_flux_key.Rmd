...
The aquatic gas with the most historical interest, oxygen represents a key 
indicator of aquatic health. Loading in some data from the South Platte via the
USGS, we can see that it cycles with season and time of day. 
```{r}
...
Both cycles are driven by two main factors (1) the change in solubility of gases
...
in air-tight bottles, preserved, and returned to a lab to be analysed. Other 
...
in Madison, WI, see if it is a source or sink of methane in the landscape, and make a flux estimate.
