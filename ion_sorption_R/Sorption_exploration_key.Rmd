...
## NHD Flow lines tool now makes you unlist their specific contents. 
## There should be a point origin object and flowlines object to retrieve them the easiest way is as follows
...
maps quickly. These maps dynamic and use the package 'leaflet' in the background
...
```{r}
metals_tss <- read_csv('data/c_metals_tss.csv')
```
...
for sites, I suggest USGS-09260000. 
...
Describe any seasonal or annual trends you find in your figure caption.
